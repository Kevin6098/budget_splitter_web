...
const translations = {
  en: {
    ...
    cta: {
      ...
      lead: 'Get Xsplit and keep shared expenses simple.',
  ...
  ms: {
    ...
    cta: {
      ...
      lead: 'Dapatkan Xsplit dan kekalkan perbelanjaan berkongsi mudah.',
...
function updateMeta(lang, t) {
  ...
  const titleText = t.hero ? `${t.hero.title} ${t.hero.titleLine2}` : 'Xsplit';
